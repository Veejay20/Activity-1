...
public class MainActivity extends AppCompatActivity {
    Button button_red,button_blue,button_green,button_violet,button_yellow,button_reset;
        ...
        button_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_reset.getText().equals("Reset"))
                {
                    ...
                    Toast.makeText(MainActivity.this, "You have successfully changed the color to white",Toast.LENGTH_LONG).show();
                }
            }
        });
